...
let nyTekst = document.createTextNode("hejhejhejhejehejhej");
newArticle.appendChild(nyTekst);

// Test om DOM’en er loadet - Øvelse 5
...
//Øvelse 6
img1.addEventListener("click", nytImg);
function nytImg() {
  let myRand = Math.floor(Math.random() * 10);
  img1.src = "https://placeimg.com/400/300/arch?t=" + myRand;
}
